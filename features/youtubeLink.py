...
def getYoutubeLink(messageText):
    ...
    if len(linkText.split()) > 1:
        ...
        # Otherwise, append https:// and try the youtube link
        else:
            ...
            if testLink.status_code == 200:
                ...
                + '!play https://www.youtube.com/watch?v=FWO5Ai_a80M')
...
def searchYoutube(searchText):
    searchUrl = ('https://www.googleapis.com/youtube/v3/search?order=relevance'
                + '&part=snippet&type=video&searchmaxResults=1&key=AIzaSyBDMh6gLimiZo7vQd0U-wiOdsoQs5O2jiM'
                + searchText)
